...
//                return context.getString(R.string.text_start_dasomtalk_tutorial_2)
    ...
    fun getMealFinishBeanQUiAction(category: String): KebbiAnimData {
        return when (category) {
            ...
            OnethefullBase.SLEEP_TIME_NAME -> {
                arrayListOf(
                    KebbiAnimData(R.raw.old_kid_music, context.getString(R.string.text_beanq_sleep_time_1), ""),
                    KebbiAnimData(R.raw.old_kid_smile, context.getString(R.string.text_beanq_sleep_time_2), ""),
                    KebbiAnimData(R.raw.old_kid_chorong, context.getString(R.string.text_beanq_sleep_time_3), ""),
                ).random()
            }
            // 기상문답 - 아침식사 알람 이후
            OnethefullBase.WAKEUP_TIME_NAME -> {
                arrayListOf(
                    KebbiAnimData(R.raw.old_kid_chorong, context.getString(R.string.text_beanq_wakeup_time_1), ""),
                    KebbiAnimData(R.raw.old_kid_smile, context.getString(R.string.text_beanq_wakeup_time_2), ""),
                    KebbiAnimData(R.raw.old_kid_listening, context.getString(R.string.text_beanq_wakeup_time_3), ""),
                ).random()
            }
            ...
            OnethefullBase.BREAKFAST_NAME, OnethefullBase.BREAKFAST_TIME_NAME -> {
                arrayListOf(
                    KebbiAnimData(R.raw.old_kid_listening, context.getString(R.string.text_beanq_breakfast_time_1), ""),
                    KebbiAnimData(R.raw.old_kid_smile, context.getString(R.string.text_beanq_breakfast_time_2), ""),
                    KebbiAnimData(R.raw.old_kid_music, context.getString(R.string.text_beanq_breakfast_time_3), ""),
                ).random()
            }
            ...
            OnethefullBase.LUNCH_NAME, OnethefullBase.LUNCH_TIME_NAME -> {
                arrayListOf(
                    KebbiAnimData(R.raw.old_kid_shy, context.getString(R.string.text_beanq_lunch_time_1), ""),
                    KebbiAnimData(R.raw.old_kid_love, context.getString(R.string.text_beanq_lunch_time_2), ""),
                    KebbiAnimData(R.raw.old_kid_smile, context.getString(R.string.text_beanq_lunch_time_3), ""),
                ).random()
            }
            ...
            OnethefullBase.DINNER_NAME, OnethefullBase.DINNER_TIME_NAME -> {
                arrayListOf(
                    KebbiAnimData(R.raw.old_kid_love, context.getString(R.string.text_beanq_dinner_time_1), ""),
                    KebbiAnimData(R.raw.old_kid_shy, context.getString(R.string.text_beanq_dinner_time_2), ""),
                    KebbiAnimData(R.raw.kid_sleepy, context.getString(R.string.text_beanq_dinner_time_3), ""),
                ).random()
            }
