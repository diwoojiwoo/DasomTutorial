package com.onethefull.dasomtutorial.contents.toast;
...
public class Toasty {
    ...
    @CheckResult
    public static Toast successDasom(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        if (BuildConfig.TARGET_DEVICE == "BEANQ") {
            return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                    ToastyUtils.getColor(context, R.color.successColor), ToastyUtils.getColor(context, R.color.defaultTextColor),
                    duration, withIcon, true);
        } else {
            return dasomCustom(context, message, ToastyUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                    ToastyUtils.getColor(context, R.color.successColor), ToastyUtils.getColor(context, R.color.defaultTextColor),
                    duration, withIcon, true);
        }
    }
    ...
    public static Toast dasomCustom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        final View toastLayout = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(com.onethefull.dasomtutorial.R.layout.toast_dasom, null);
        final TextView toastTextView = toastLayout.findViewById(com.onethefull.dasomtutorial.R.id.text_desc);
